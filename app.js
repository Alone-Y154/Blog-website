...
app.get("/posts/:topic",(req,res) => {
  posts.forEach((post) => {
    // if (posts == []) {
    //   res.render("post",{postTitle: "Please compose a Post first", postContent: ""});
    // }
    if (_.lowerCase(req.params.topic) === _.lowerCase(post.inputTitle)) {
      res.render("post",{postTitle: post.inputTitle , postContent: post.inputPost});
    }
  });
